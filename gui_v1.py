                ...
                layout = [
                    ...
                    [sg.Frame(layout=[
                     ...
                     sg.Frame(layout=[
                        ...
                        [sg.Text(i18n("harvest进程数")),sg.Slider(range=(1,n_cpu),key="n_cpu",resolution=1,orientation="h",default_value=data.get("n_cpu",4),enable_events=True)], # n_cpu global for harvest, data['n_cpu'] for RVC
